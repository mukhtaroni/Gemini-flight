...
"""
Write a book_flight function in Flight_Manager.py file that send a POST request to a prebuilt endpoint?
import requests

def book_flight(flight_details):
    endpoint = "https://api.example.com/book_flight"  # Replace this with the actual endpoint URL
    response = requests.post(endpoint, json=flight_details)
